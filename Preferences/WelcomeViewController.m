...
- (void)viewDidLoad {
    ...
    [[self headerImageView] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LiddellPreferences.bundle/welcome/header.png"]];
    ...
    [[self twitterCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LiddellPreferences.bundle/welcome/twitter.png"] forState:UIControlStateNormal];
    ...
    [[self githubCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LiddellPreferences.bundle/welcome/github.png"] forState:UIControlStateNormal];
    ...
    [[self discordCellIcon] setImage:[UIImage imageWithContentsOfFile:@"/Library/PreferenceBundles/LiddellPreferences.bundle/welcome/discord.png"] forState:UIControlStateNormal];
